...
<p>College's Complaint Management System </p>
<ul>
...
<h2>About</h2>
<p class="about_text">Welcome to Loyola College's Complaint Management System! This user-friendly platform allows students and staff to effortlessly submit and track complaints. With comprehensive complaint categories and a transparent communication system, it ensures prompt and confidential issue resolution. Log in, submit your complaint, and stay informed throughout the process. Loyola College is dedicated to providing a secure and efficient system for the well-being of our college community. Your feedback is crucial for continuous improvement. </p>
</div>
<div class="academies" id="academies">
<br><br><br><br><br><br><br><br><button class="button button3" onclick="location.href='portals.php'">Log In >></button>
</div>
<div class="contact" id="contact">
<h2>Contact for technical issues</h2>
<p class="about_text">Mr Guna<br>Email: complaintsloyola@gmail.com<br><br>Our team is happy to assist you with any need. Kindly send an email and we'll get back to you. If you want have a telephonic call, we can schedule with it during the weekend. </p>
</div>
...
<div class="footer1">
<h2>Mission</h2>
<p class="mission">Our mission at Loyola College's Complaint Management System is to foster a positive campus environment by providing a seamless platform for students and staff to voice concerns. We are committed to ensuring transparency, confidentiality, and efficient resolution of reported issues. Through continuous improvement, we aim to enhance the overall well-being and satisfaction of our college community. Your feedback is invaluable in achieving this mission.</p>
</div>
<div class="footer2">
